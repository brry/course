...
% \item R installation instructions: \href{https://bookdown.org/brry/course\#install}{bookdown.org/brry/course\#install}
...
\pause
More at \href{https://bookdown.org/brry/course\#settings}{bookdown.org/brry/course\#settings}\\[0.5em]
\pause
