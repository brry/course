...
\begin{center}
    \begin{columns}
    \column{22.0em}
    \begin{block}{}{\Large ~Introductory + advanced \includegraphics[width=0.7cm]{externalfig/Rlogo.png} ~course}
    \end{block}
    \end{columns}
\vspace{1em}
...
dummy <- pbapply::pblapply(c("F","VLKAY", "AMZN","AAPL","GOOG","MSFT"),
...
\end{itemize}
\pause
The homework is at \url{https://github.com/brry/course/blob/master/uni.md\#homework}
\end{frame}
...
\begin{frame}[fragile]{for loop solution}
\vspace{-0.5em}
...
%------------------------------------------------------------%
%------------------------------------------------------------%
\subsection{Session x: statistics}
%------------------------------------------------------------%
%------------------------------------------------------------%
...
%------------------------------------------------------------%
%------------------------------------------------------------%
\subsection{Session x: shapefiles (R as GIS)}
%------------------------------------------------------------%
%------------------------------------------------------------%

\begin{frame}[fragile]{Rstudio Tipps and Tricks}
\begin{enumerate}[<+->]
\item \hyperlink{rstudio}{Rstudio settings slide}
