...
For each element, get the \rcode{class, dim, ncol, NCOL, median, range}.
\item Instead of using \rcode{ToothGrowth[5,2]}, you can also explicitely call the subset function with \rcode{"["(ToothGrowth, i=5, j=2)}.\\
