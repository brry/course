...
-   **Fundamentals of Programming** [videos + autograded exercises](https://open.hpi.de/courses/hpi-dh-fprog2024), slides:
    -   Infrastructure](link coming soon) (ca 1-3 hours)
...
Install R on Linux **Ubuntu** ([supported versions](https://cloud.r-project.org/bin/linux/ubuntu/)) so that `sudo apt upgrade` installs the latest R version if outdated (sources: [Kris Eberwein](https://www.r-bloggers.com/how-to-install-r-on-linux-ubuntu-16-04-xenial-xerus), [Dean Attali](https://www.digitalocean.com/community/tutorials/how-to-set-up-r-on-ubuntu-14-04), [Lisa Tagliaferri](https://www.digitalocean.com/community/tutorials/how-to-install-r-on-ubuntu-20-04)):
...
-   [Tools]{style="background-color:aquamarine"} - [Global Options]{style="background-color:aquamarine"} - Appearance
    ...
    -   Editor theme: **Cobalt**
-   [Tools]{style="background-color:aquamarine"} - [Global Options]{style="background-color:aquamarine"} - Sweave
...
-   
    ...
    1.  Go to [github.com/brry/course](https://github.com/brry/course) - [Code]{style="background-color:lime"} - Copy URL
...
-   [base](https://raw.githubusercontent.com/rstudio/cheatsheets/master/base-r.pdf) and [advanced](https://www.rstudio.com/wp-content/uploads/2016/02/advancedR.pdf) cheatsheets from [Rstudio](https://posit.co/resources/cheatsheets/)
...
Quick guide: start a research project under version control
...
Installiere R auf Linux **Ubuntu** ([unterstützte Versionen](https://cloud.r-project.org/bin/linux/ubuntu/)), sodass `sudo apt upgrade` auf die neueste R Version aktualisiert, falls sie veraltet ist (Quellen: [Kris Eberwein](https://www.r-bloggers.com/how-to-install-r-on-linux-ubuntu-16-04-xenial-xerus), [Dean Attali](https://www.digitalocean.com/community/tutorials/how-to-set-up-r-on-ubuntu-14-04), [Lisa Tagliaferri](https://www.digitalocean.com/community/tutorials/how-to-install-r-on-ubuntu-20-04)):
