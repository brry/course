...
- <span style="background-color:aquamarine">Tools</span> - <span style="background-color:aquamarine">Global Options</span> - Appearance
    ...
    - Editor theme: **Cobalt**
- <span style="background-color:aquamarine">Tools</span> - <span style="background-color:aquamarine">Global Options</span> - Sweave (only relevant if you work with Rnw files)
