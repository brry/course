...
My main slidedeck (in a single PDF) is avalaible through two openHPI courses.
...
- [German](https://open.hpi.de/courses/programmieren-r2022), ca 20-50 hours   
- [English](https://open.hpi.de/courses/hpi-dh-fprog2022), ca 30-70 hours

There is also material for a course taking [a few hours](https://github.com/brry/hour).  
My [old slides](https://github.com/brry/course/raw/master/RcourseBerry.pdf) are still directly available.
...
[Windows](#windows), [Mac](#mac), [Linux](#linux), [Manjaro](#manjaro-linux)
...
- open a terminal (CTRL+ALT+T) and paste (CTRL+SHIFT+V) the following lines one by one.  
  On Linux **Mint**, replace `$(lsb_release -cs)` with e.g. `focal`, as [listed](https://cloud.r-project.org/bin/linux/ubuntu/).  
