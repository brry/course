...
-   **Fundamentals of Programming** [videos + autograded exercises](https://open.hpi.de/courses/hpi-dh-fprog2025), slides:
    ...
    - [Python](https://www.dropbox.com/scl/fi/7omcctqlypryi16l7tkqy/PyCourse.pdf?rlkey=dyfe44uc0g6g97xssl1oz9wy6&dl=0) (ca 20-50 hours)
...
-   Create a github account at <https://github.com/signup>. Use a short username!
...
-   
    ...
    1.  Go to a repo (for example [github.com/brry/course](https://github.com/brry/course)) and click on  [Code]{style="background-color:lime"} - Copy URL
