...
**to programming with R (and Python)!**\
...
- **Fundamentals of Programming** 
  - [videos + autograded exercises](https://open.hpi.de/learn/hpi-dh-fprog2026) (free, email registration needed)
  - [slides](https://www.dropbox.com/scl/fo/h8j6ckpeaqlfq5nbbcrok/ACzRP2qmnHjAxgFZMaqoz5I?rlkey=u6tknfg3szpqy3rshxnlxn6l2&dl=0) for:
    - Infrastructure Git + Quarto (ca 1-3 hours)
    - Python (ca 20-50 hours)
    - R (ca 30-70 hours)
  - [software installation guide](https://github.com/brry/fpsetup#software-installation-guide)
...
-   in the terminal (search with `CMD` + `SPACE`), run (one after the other)\
`brew install --cask r`\
...
variables_to_compare <- c("v1", "v2")
effect_sizes <- sapply(variables_to_compare, function(var) {
  gr1 <- values[values$group == 0, var]
  gr2 <- values[values$group == 1, var]
...
```{r elegant_coding9b, eval=FALSE}
sapply(c("v1","v2"), function(col)
...
In the git folder you could use the following structure (the names are suggestive only, adapt to your needs):
...
-   Manage authentification without renewing PAT access tokens via SSH ([screenshots](https://www.r-bloggers.com/rstudio-and-github) for these instructions, if wanted):
...
-   
    ...
    1.  Go to a repo (for example [github.com/brry/fpsetup](https://github.com/brry/fpsetup)) and click on  [Code]{style="background-color:lime"} - SSH *(if logged in)* - Copy URL
...
- doesn't always follow [best practices](#good-practice)
- is hard to maintain and has security issues (see [below](#detailed-problems))
- needs experienced senior developers to catch issues
- lowers debugging skills
- reduces learning to think in a structured manner (see [below](#ai-in-learning))

## solution

- learn basic programming yourself
- develop good coding habits from the beginning  
- make mistakes, debug, struggle, research, think, build problem solving skills
- implement AI-assisted code critically
- enjoy [good employment perspectives](https://www.noahpinion.blog/p/ai-keeps-stubbornly-refusing-to-take)


## AI in learning

*don't bring a forklift to a fitness studio to lift weights*  
*AI = amplified intelligence -> develop skills to be augmented*
...
- 2026-09 OpenAI disrespecting IP may cause [damage to open science](https://garymarcus.substack.com/p/two-dire-warnings-one-from-terence)
- 2026-08 AI R&D progress may [need pacing to be safe](https://open.substack.com/pub/noahpinion/p/should-we-pace-ai-self-improvement?) for humanity
- 2026-07 when OpenAI guardrails are circumvented, [agents use zero-day-exploits](https://open.substack.com/pub/garymarcus/p/openais-disconcerting-hack-of-huggingface)
- 2026-07: developers have [decreasing trust in AI coding tools output](https://uvik.net/blog/ai-coding-assistant-statistics/)
- 2026-07 [jailbreaking still is a problem](https://www.technologyreview.com/2026/07/30/1140927/a-fundamental-flaw-leaves-llms-vulnerable-to-attack/) and may remain one forever
- 2026-07 AI coding has [not yet changed the world](https://freddiedeboer.substack.com/p/the-project-of-software-is-complete) all that much
- 2026-06: AI has [faulty medical reasoning and hallucinations, uses inappropriate shortcuts](https://www.nature.com/articles/s41591-026-04501-8)
- 2026-06: AI support system used to [hijack over 20,000 accounts](https://www.helpnetsecurity.com/2026/06/08/instagram-ai-support-vulnerability-account-takeovers/)
- 2026-06: OpenAI and Anthropic [do not trust their own AI](https://techtrenches.dev/p/when-your-vendor-becomes-your-competitor) and hire humans instead
- 2026-05: real business impact of AI is low but it [de-skills engineers and erodes career growth](https://humanware.substack.com/p/ai-is-turning-software-development)
- 2026-05: autonomous agents are [vulnerable to tool-chaining attacks](https://garymarcus.substack.com/p/breaking-autonomous-agents-are-a)
- 2026-05: AI code [looks correct but isn’t](https://open.substack.com/pub/techtrenches/p/ai-is-a-mirror-of-our-engineering), engineers don’t trust it but don’t check it either
- 2026-04: AI-generated code gets [rewritten/reverted at higher rates than human code](https://byteiota.com/ai-coding-productivity-2026-benchmarks-show-real-impact/)
- 2026-04: AI agents [still destroy production databases](https://garymarcus.substack.com/p/dario-amodei-hype-ai-safety-and-the) and cannot be trusted
- 2026-04: [incidents per pull request and bugs per developer are rising](https://www.faros.ai/research/ai-acceleration-whiplash) at increasing pace
- 2026-04: sycophantic AI reduces healthy skepticism, AI [agents need clear specs](https://open.substack.com/pub/handyai/p/your-ceo-is-suffering-from-ai-psychosis)
- 2026-04: as a society, we may [forget how to code](https://techtrenches.dev/p/the-west-forgot-how-to-make-things) and have a hard time re-learning
- 2026-04: widespread AI usage creates additional [maintenance load on senior developers](https://techtrenches.dev/p/the-human-cost-of-10x-how-ai-is-physically)
- 2026-04: Claude code itself has "[corner-cutting](https://techtrenches.dev/p/the-snake-that-ate-itself-what-claude) and wilful blindness at scale"
- 2026-04: ChatGPT cannot reliably keep track of [time](https://gizmodo.com/sam-altman-says-itll-take-another-year-before-chatgpt-can-start-a-timer-2000743487)
- 2026-03: AI code caused [Amazon outage](https://www.digitaltrends.com/computing/ai-code-wreaked-havoc-with-amazon-outage-and-now-the-company-is-making-tight-rules/)
- 2026-03: AI adoption [decreases delivery speed](https://dev.to/alexcloudstar/the-ai-productivity-paradox-why-developers-who-ship-more-code-are-not-actually-more-productive-12f7) and causes a drop in system stability
- 2026-03: Medical X-ray [benchmark scores are worthless](https://arxiv.org/abs/2603.21687) (top rank without using an image)
- 2026-03: measured [productivity gains are lower than perceived](https://www.nber.org/papers/w34984)
- 2026-03: Gen-AI-assisted changes cause outages, [decrease maintainability](https://garymarcus.substack.com/p/a-spate-of-outages-including-incidents)
- 2026-02: AI adoption stalls, [performance gains plateau](https://hbr.org/2026/02/why-ai-adoption-stalls-according-to-industry-data), AI fails to deliver durable impact
- 2026-01: engineers who lean on AI to write code [understand it less well](https://www.anthropic.com/research/AI-assistance-coding-skills)
- 2025-12: AI-generated code contains [more bugs and errors](https://www.techradar.com/pro/security/ai-generated-code-contains-more-bugs-and-errors-than-human-output) than human output
- 2025-11: With increasing complexity, it gets [harder to check](https://open.substack.com/pub/oneusefulthing/p/on-working-with-wizards) if AI output is correct
- 2025-11: AI output [lowers skepticism](https://open.substack.com/pub/addyo/p/treat-ai-generated-code-as-a-draft) during reviews, stunts junior devs knowledge gain
- 2025-11: LLMs are [bad at conceptual programming](https://open.substack.com/pub/clauswilke/p/llms-excel-at-programminghow-can) 
- 2025-10: AI-written code causes [security breaches](https://www.techradar.com/pro/security/one-in-five-security-breaches-now-thought-to-be-caused-by-ai-written-code), hard to track down vulnerabilites
- 2025-09: 95% of companies see [no return on AI investment](https://www.reddit.com/r/cscareerquestions/s/JHrH5pGxDU) (reasons [why](https://open.substack.com/pub/garymarcus/p/why-is-the-roi-on-generative-ai-so))
- 2025-09: AI assistants actually [slow down software development](https://open.substack.com/pub/mikelovesrobots/p/wheres-the-shovelware-why-ai-coding) ([reproducible](https://arxiv.org/abs/2507.09089))
- 2025-08: [prompt injection attacks](https://venturebeat.com/ai/anthropic-launches-claude-for-chrome-in-limited-beta-but-prompt-injection-attacks-remain-a-major-concern) remain a major concern
- 2025-08: Vibe coding without engineering discipline creates [unmaintainable code](https://open.substack.com/pub/addyo/p/vibe-coding-is-not-the-same-as-ai) 
- 2025-08: Coding agents create [cybersecurity vulnerabilities](https://open.substack.com/pub/garymarcus/p/llms-coding-agents-security-nightmare) in numerous ways
- 2025-07: AI usage [degrades our ability to catch bugs](https://codebytom.blog/2025/07/the-hidden-cost-of-ai-reliance), creates a reliability problem
- 2025-07: AI coding tools chase phantom bugs and [destroy real production databases](https://arstechnica.com/information-technology/2025/07/ai-coding-assistants-chase-phantoms-destroy-real-user-data/)
- 2025-05: With / despite AI tools, the [number of software developers is still increasing](https://www.slashdata.co/post/global-developer-population-trends-2025-how-many-developers-are-there)
- 2024-12: AI coding collapses under real-world pressure, requires [expertise for final 30%](https://open.substack.com/pub/addyo/p/the-70-problem-hard-truths-about)
- 2024-05: Coders with AI assistance write more [security leaks](https://www.louisbouchard.ai/genai-coding-risks) (with less awareness of them)
...
saveRDS(one_single_object, "object.rds")
explicit_object_name <- readRDS("object.rds")
```
...
```{r gradingpage, child='_grading.Rmd'}
```