...
- `reduce_data_size.R`: read big files, select interesting bits, store in `raw_data_small/` with `write.csv`. If you have (many) text entries with commas but no tabstops, use `write.table(..., sep="\t", row.names=FALSE, fileEncoding="UTF-8")`
- `process_data.R` with
